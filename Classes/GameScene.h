...
static int background_linked_list[16][5] = {{1,  -1},
                                            {2,  3,  4,  -1},
                                            {3,  4,  -1},
                                            {2,  4,  -1},
                                            {2,  3,  -1},
...
private:
    ...
    bool initialisation_over = false;
    float x_screen;
    float y_screen;
    float game_duration;
    ...
    /******************* BACKGROUND SCROLL MANAGMENT ***************/
    Background **pool_background_scroll;
    int background_displayed_nbr = -1;
...
public:
    ...
    void reset_scrolling_background();
