...
public:
     ...
     * @endcode
     */
    static GridView* create(cocos2d::extension::TableViewDataSource* dataSource, cocos2d::Size size, int);
    /**
     ...
     * @endcode
     */
    static GridView* create(cocos2d::extension::TableViewDataSource* dataSource, cocos2d::Size size, cocos2d::Node *container, int);
    /**
     * @js ctor
     */
    GridView();
