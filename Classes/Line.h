...
static const float DISTRIB_COMPLEX[8][9] = {{0.2, 0.1, 0.17, 0.17, 0.1, 0.27},
                                            {0.17, 0.23, 0.23, 0.13, 0.07, 0.17},
                                            {0.1, 0.06, 0.2, 0.2, 0.23, 0.06, 0.1, 0.03},
                                            { 0.06, 0.23, 0.1, 0.2, 0.27, 0.13},
                                            { 0.1, 0.23, 0.1, 0.17, 0.1, 0.06, 0.03, 0.2 },
                                            { 0.03, 0.2, 0.17, 0.06, 0.06, 0.1, 0.27, 0.1, 0.1 },
                                            { 0.27, 0.03, 0.03, 0.1, 0.06, 0.23, 0.03, 0.06, 0.17 },
                                            { 0.06, 0.06, 0.17, 0.3, 0.24, 0.1, 0.03 }};

static const float DISTRIB_SIMPLE[2][5] = {{0.23, 0.33, 0.27, 0.23}, {0.3, 0.1, 0.23, 0.17, 0.2}};
        ...
        public cocos2d::Node {
            ...
            void assign_line_points_complex(int);
